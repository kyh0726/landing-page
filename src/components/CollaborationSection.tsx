  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
      <div ref={leftRef} className="relative">
        ...
        {/* 커스텀 그룹 카드 */}
        <Card className="absolute -bottom-6 -left-6 bg-gradient-to-br from-orange-500 to-red-500 text-white border-0 w-52 hover:from-orange-600 hover:to-red-600 hover:scale-110 hover:shadow-2xl transition-all duration-300 cursor-pointer group/custom">
      ...
      <div ref={rightRef}>
        ...
        <div className="space-y-5 mb-10">
          ...
          <div className="flex items-center space-x-4 hover:bg-orange-50 p-4 rounded-xl transition-all duration-200 cursor-pointer group/feature border border-transparent hover:border-orange-200 hover:shadow-sm">
            <div className="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center group-hover/feature:bg-orange-200 transition-colors duration-200 shadow-sm">
              <span className="text-orange-600 text-xl group-hover/feature:scale-110 transition-transform duration-200">👥</span>
            </div>
            <div>
              <div className="text-lg font-semibold text-gray-900 group-hover/feature:text-orange-700 transition-colors duration-200">커스텀 그룹</div>
